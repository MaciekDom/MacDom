                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="login" class="col-sm-4 col-form-label text-md-right"></label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="width: 210px;">
                                    {{ __('Zaloguj się do systemu') }}
                                </button>
                            </div>
                        </div><br>
                    </form>
